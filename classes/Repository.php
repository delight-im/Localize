                ...
                if ($lang != $this->defaultLanguage) {
                    ...
                    foreach ($defLangPhrases as $defLangPhrase) { // loop through phrases of default language
                        ...
                        if (!isset($currentPhrase)) { // if phrase does not exist in this language yet
                            $this->addPhrase($langID, $defLangPhrase->getID(), $defLangPhrase->getPhraseKey(), $defLangPhrase->getPayload(), $defLangPhrase->getGroupID(), $defLangPhrase->isEnabledForTranslation(), !$isExport, true); // add phrase from default language
                        }
                    }
                }
